...
function CRMClientDetailsLoanEDRForeclosure({ data, onClose }) {
  ...
  }, [data?.deductionAmount, dataRef, template?.amount]);
      ...
      <DialogContent>
        <div className="grid sm:grid-cols-2 gap-4 py-2">
          ...
          <CurrencyTextField
            ...
            helperText={
              getTextFieldFormikProps(formik, "transactionAmount").helperText ||
              `Next repayment N${template?.amount}`
            }
          />
          {/* <TextField
            select
...
export default CRMClientDetailsLoanEDRForeclosure;
