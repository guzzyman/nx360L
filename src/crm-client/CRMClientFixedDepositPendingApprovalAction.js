...
export default function CRMClientFixedDepositPendingApprovalAction(props) {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      locale: "en",
      note: "",
      approvedOnDate: format(new Date(), "dd MMMM yyyy"),
    },
  ...
  return (
    <Modal onClose={onClose} size="md" title="Approval" {...rest}>
      <TextField
        label="Note"
        multiline
        rows={3}
