...
import TelesalesDetailsHistory from "./TelesalesDetailsHistory";
import TelesalesDetailsDiscuss from "./TelesalesDetailsDiscuss";
import TelesalesDetailsFile from "./TelesalesDetailsFile";
...
function RecoveryDetails(props) {
  ...
  const recoveryDetails = nx360TeleSalesApi.useGetAllSalesByIdQuery(id, {
    skip: !id,
  });
