...
export const nx360HotleadsApi = nimbleX360Api.injectEndpoints({
  endpoints: (builder) => ({
    getAllHotLeads: builder.query({
      query: ({ ...params }) => ({
        url: "/telesales",
        params: {
          orderBy: "id",
    ...
    getMyTeamHotLeads: builder.query({
      query: ({ ...params }) => ({
        url: "/telesales",
        params: {
          orderBy: "id",
