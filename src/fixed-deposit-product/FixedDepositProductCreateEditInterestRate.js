                  ...
                  <div className="relative bg-gray-100 p-4 rounded-md mb-4">
                    ...
                    <>
                      ...
                      >
                        ...
                        >
                          {fixedDepositProductTemplate?.chartTemplate?.periodTypes?.map(
                            (option) => (
                          ...
                          (incentive, incentiveIndex) => {
                            ...
                            return (
                              <div className="relative bg-gray-100 p-4 rounded-md grid sm:grid-cols-2 lg:grid-cols-3 lg: xl:grid-cols-5 gap-4 mb-4">
                                ...
                                >
                                  {fixedDepositProductTemplate?.chartTemplate?.attributeNameOptions?.map(
                                    (option) => (
                                      <MenuItem
                                        key={option.id}
                                        value={option.id}
                                ...
                                >
                                  {fixedDepositProductTemplate?.chartTemplate?.conditionTypeOptions?.map(
                                    (option) => (
                                      <MenuItem
                                        key={option.id}
                                        value={option.id}
                                ...
                                >
                                  {fixedDepositProductTemplate?.chartTemplate?.incentiveTypeOptions?.map(
                                    (option) => (
                                      <MenuItem
                                        key={option.id}
                                        value={option.id}
