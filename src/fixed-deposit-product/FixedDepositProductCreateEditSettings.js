    ...
    return (
      <>
        ...
        >
          ...
          >
            {fixedDepositProductTemplate?.[frequencyTypeOptionKey]?.map(
              (option) => (
          ...
          >
            ...
            {!!formik.values?.preClosurePenalApplicable && (
              <>
                ...
                >
                  {fixedDepositProductTemplate?.preClosurePenalInterestOnTypeOptions?.map(
                    (option) => (
                      <MenuItem key={option.id} value={option.id}>
                        {option.value}
                      </MenuItem>
        ...
        <>
          ...
          >
            ...
            {!!formik.values?.withHoldTax && (
              ...
              >
                {fixedDepositProductTemplate?.taxGroupOptions?.map((option) => (
                  <MenuItem key={option.id} value={option.id}>
                    {option.name}
                  </MenuItem>
                ))}
