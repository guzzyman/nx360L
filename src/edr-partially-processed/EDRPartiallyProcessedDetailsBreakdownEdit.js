...
function EDRPartiallyProcessedDetailsBreakdownEdit(props) {
  ...
  const [updateEDRTransactionMutation, updateEDRTransactionMutationResult] =
    nxEDRPartiallyProcessedApi.useUpdateEDRMutation();

  const searchClientQueryResult =
    nxEDRPartiallyProcessedApi.useGetEDRClientsQuery(
...
export default EDRPartiallyProcessedDetailsBreakdownEdit;
