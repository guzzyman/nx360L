  ...
  return (
    <>
      <Paper className="p-4 mb-4">
        ...
        <RadioGroup
          row
          // defaultValue={recurringDepositProductTemplate?.accountingRule?.id}
          {...getTextFieldFormikProps(formik, "accountingRule")}
        >
          {recurringDepositProductTemplate?.accountingRuleOptions
            ?.slice?.(0, 2)
            ?.map((rule) => (
              <FormControlLabel
                name="accountingRule"
        ...
        <>
          <Paper className="p-4 mb-4">
            ...
            >
              ...
              >
                {recurringDepositProductTemplate?.accountingMappingOptions?.assetAccountOptions?.map(
                  (option) => (
          ...
          <Paper className="p-4 mb-4">
            ...
            >
              ...
              >
                {recurringDepositProductTemplate?.accountingMappingOptions?.incomeAccountOptions?.map(
                  (option) => (
                    <MenuItem key={option.id} value={option.id}>
                      {option.name}
                    </MenuItem>
          ...
          <Paper className="p-4 mb-4">
            ...
            >
              ...
              >
                {recurringDepositProductTemplate?.accountingMappingOptions?.expenseAccountOptions?.map(
                  (option) => (
                    <MenuItem key={option.id} value={option.id}>
                      {option.name}
                    </MenuItem>
          ...
          <Paper className="p-4 mb-4">
            ...
            >
              ...
              >
                {recurringDepositProductTemplate?.accountingMappingOptions?.liabilityAccountOptions?.map(
                  (option) => (
                    <MenuItem key={option.id} value={option.id}>
                      {option.name}
                    </MenuItem>
                  ...
                  (_, valueKey) => {
                    return (
                      <>
                        ...
                        >
                          {recurringDepositProductTemplate?.paymentTypeOptions?.map(
                            (option) => (
                              <MenuItem key={option.id} value={option.id}>
                                {option.name}
                              </MenuItem>
                  ...
                  (_, valueKey) => {
                    return (
                      <>
                        ...
                        >
                          {recurringDepositProductTemplate?.chargeOptions?.map(
                            (option) => (
                              <MenuItem key={option.id} value={option.id}>
                                {option.name}
                              </MenuItem>
                  ...
                  (_, valueKey) => {
                    return (
                      <>
                        ...
                        >
                          {recurringDepositProductTemplate?.penaltyOptions?.map(
                            (option) => (
                              <MenuItem key={option.id} value={option.id}>
                                {option.name}
                              </MenuItem>
