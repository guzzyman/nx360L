...
function LoanProductCreateEditCharges({ formik, loanProductTemplate }) {
  const [selectedCharge, setSelectedCharge] = useState(null);
  const [selectedOverdueCharge, setSelectedOverdueCharge] = useState(null);
  ...
  return (
    <>
      {renderCharges(
        ...
        setSelectedCharge,
        "charges",
        loanProductTemplate?.chargeOptions
      )}
      {renderCharges(
        "Overdue Charges",
        selectedOverdueCharge,
        setSelectedOverdueCharge,
        "charges",
        loanProductTemplate?.penaltyOptions
      )}
    </>
  );
}

export default LoanProductCreateEditCharges;
