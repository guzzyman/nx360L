  ...
  return (
    <>
      ...
      >
        ...
        >
          <Button
            ...
            onClick={() => navigate(RouteEnum.ADMINISTRATION_LOAN_PRODUCT_ADD)}
          >
            Create Loan
          </Button>
        </AuthUserUIPermissionRestrictor>
      ...
      <Paper className="p-4">
        ...
        <AuthUserUIPermissionRestrictor
          permissions={[UIPermissionEnum.CREATE_DIVIDEND_SHAREPRODUCT_CHECKER]}
        >
          <DynamicTable
            ...
            rowProps={(row) => ({
              onClick: () =>
                navigate(
                  generatePath(RouteEnum.ADMINISTRATION_LOAN_PRODUCT_EDIT, {
                    id: row.original.id,
                  })
                ),
            })}
